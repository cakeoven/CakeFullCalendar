...
<div class="actions">
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete Event Type', true), array('plugin' => 'calendar', 'action' => 'delete', $eventType['EventType']['id']), null, sprintf(__('Are you sure you want to delete %s?', true), $eventType['EventType']['name'])); ?> </li>
		<li><?php echo $this->Html->link(__('Manage Event Types', true), array('plugin' => 'calendar', 'action' => 'index')); ?> </li>
		<li><li><?php echo $this->Html->link(__('View Calendar', true), array('plugin' => 'calendar', 'controller' => 'calendar')); ?></li>
	</ul>
</div>
<div class="related">
